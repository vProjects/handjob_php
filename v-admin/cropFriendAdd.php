...
?>
        ...
        <div class="span9" id="content_container">
        	<blockquote>
                <p>Edit a Friend</p>
                <small>
                	<cite title="Source Title">Edit Friend of your website.</cite>
                </small>
            </blockquote>
			...
			?>
            	<div class="image_model" style="width:100%;max-width:500px;float:left;height:100%;">
                    ...
                    <a href="cropFriendAdd.php?filename=<?php echo $filename; ?>&save=true" >

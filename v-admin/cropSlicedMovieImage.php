        ...
        <div class="span9" id="content_container">
			...
			?>
                <div class="image_model_1" style="max-width:500px;width:100%;" id="image_box">
                    <img src="../members/gallery/<?php echo $folderName."/".$filename ;?>" id="cropbox_movie"/>
                     
                </div>
                <form action="v-includes/functions/function.cropSlicedMovieImage.php" method="post" class="form_image_crop">
			...
			?>
            	<div class="image_model" style="width:100%;max-width:500px;float:left;height:100%;">
                    ...
                    <a href="cropSlicedMovieImage.php?fileName=<?php echo $filename; ?>&save=true&folderName=<?php echo $folderName; ?>&galleryId=<?php echo $galleryId; ?>" >
            ...
            <?php
				...
				if( $save_status == "true")
				{
					...
					echo '<div class="image_model" style="width:100%;max-width:500px;float:left;height:100%;">
							...
							<a href="updateSliced.php?movieId='.$folderName.'&fileName='.$filename.'&galleryId='.$galleryId.'" >
								<button class="btn btn-warning" type="button" style="left: 30%;position: relative;">

        ...
        <div class="span9" id="content_container">
			...
			?>
                <div class="image_model_1" style="max-width:500px;width:100%;" id="image_box">
                    <img src="../../videos_sample_image/<?php echo $folderName."/".$filename ;?>" id="cropbox_photo"/>
                     
                </div>
                <form action="v-includes/functions/function.cropMovieImage.php" method="post" class="form_image_crop">
			...
			?>
            	<div class="image_model" style="width:100%;max-width:500px;float:left;height:100%;">
                    ...
                    <a href="cropMovieImage.php?fileName=<?php echo $filename; ?>&save=true&folderName=<?php echo $folderName; ?>" >
            ...
            <?php
				...
				{
					$src = '../../temp/'.$filename;
					$dst_h = "../../videos_sample_image/".$folderName."/".$filename ;
					$dst_m = "../../videos_sample_image/".$folderName."/m/".$filename ;
					$dst_s = "../../videos_sample_image/".$folderName."/s/".$filename ;
					...
					echo '<div class="image_model" style="width:100%;max-width:500px;float:left;height:100%;">
							...
							<a href="updateMovie.php?galleryId='.$folderName.'&fileName='.$filename.'" >
								<button class="btn btn-warning" type="button" style="left: 30%;position: relative;">

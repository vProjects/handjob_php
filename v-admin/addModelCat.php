...
?>
        ...
        <div class="span9" id="content_container">
        	<blockquote>
                <p>Add a Model Category</p>
                <small>
                	<cite title="Source Title">Please add a model category to your website.</cite>
                </small>
            </blockquote>
            ...
            <form action="v-includes/functions/function.addCategory.php" method="post" enctype="multipart/form-data">
            	<div class="form-control v-form">
                    ...
                    <input type="text" placeholder="Model Category" class="textbox1" name="category_name"/>
                </div>
                <div class="form-control v-form">
                <div class="function_result"><?php if(isset($_SESSION['result'])){echo $_SESSION['result'];unset($_SESSION['result']);} ?></div>
                	<input type="hidden" value="model_category" name="page" />

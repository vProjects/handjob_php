...
?>
        ...
        <div class="span9" id="content_container">
			...
			?>
                ...
                <form action="v-includes/functions/function.cropMovieThumb1.php" method="post" class="form_image_crop">
			...
			?>
            	<div class="image_model" style="width:100%;max-width:500px;float:left;height:100%;">
                    ...
                    <a href="cropMovieThumb1.php?filename=<?php echo $filename; ?>&type=<?php echo $type; ?>&save=true&galleryId=<?php echo $galleryId; ?>" >
            ...
            <?php
				...
				if( $save_status == "true")
				{
					...
					if( $type == 'sliced' )
					{
						$redirect_URL = 'updateSliced.php' ;
					}
					else
					{
						$redirect_URL = 'updateMovie.php' ;
					}
					echo '<div class="image_model" style="width:100%;max-width:500px;float:left;height:100%;">
							...
							<a href="'.$redirect_URL.'?galleryId='.$galleryId.'" >
								<button class="btn btn-warning" type="button" style="left: 30%;position: relative;">

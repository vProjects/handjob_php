...
<div id="bodyContainer" class="row-fluid">
	...
	<div class="span12 blog_page">
    	<h4><a href="#" class="blog_heading"> Blog Heading</a></h4>
        <p class="blog_author_name"> Author Name</p>
        ...
        <div class="row-fluid">
        	<div class="span10 offset1">
                <div class="row-fluid blog_comment_outline">
                    <div class="span2">
                        <p class="blog_comment_name">Full Name:</p>
                    </div>
                    <div class="span10">
                        <p class=" blog_comment_section_p">Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu 
